...
- Runs an end-to-end local fMRI annotation POC with:
  - a landing flow that routes operators into either the fMRI qualification
    console or the general text facet annotator
...
- Defines `text_document` and `image_asset` archetypes plus mocked/LLM-ready
  annotators for structured text/image facet extraction.
...
Open `http://127.0.0.1:8787`. The landing screen lets you choose between:

- fMRI / BIDS Qualification: the three-page scientific data console.
- Text Facet Annotator: general text annotation for modality, strictness, and tone.
